...
{
    sMULTIROBOT_INSTNACE_INFO   =  5000,
    sMULTIROBOT_INSTNACE_ERROR  = -5000,
    sMULTIROBOT_OPEN_ERROR      = (sMULTIROBOT_INSTNACE_ERROR - 1),
    sMULTIROBOT_PDDL_OPEN_ERROR = (sMULTIROBOT_INSTNACE_ERROR - 2),
    sMULTIROBOT_BGU_OPEN_ERROR  = (sMULTIROBOT_INSTNACE_ERROR - 3),
    sMULTIROBOT_CNF_OPEN_ERROR  = (sMULTIROBOT_INSTNACE_ERROR - 4)
};

enum sHierarchicalRelocationInstance_Result
{
    sHIERARCHICAL_RELOCATION_INSTNACE_INFO   =  6000,
    sHIERARCHICAL_RELOCATION_INSTNACE_ERROR  = -6000,
    sHIERARCHICAL_RELOCATION_OPEN_ERROR      = (sHIERARCHICAL_RELOCATION_INSTNACE_ERROR - 1),
    sHIERARCHICAL_RELOCATION_PDDL_OPEN_ERROR = (sHIERARCHICAL_RELOCATION_INSTNACE_ERROR - 2),
    sHIERARCHICAL_RELOCATION_BGU_OPEN_ERROR  = (sHIERARCHICAL_RELOCATION_INSTNACE_ERROR - 3),
    sHIERARCHICAL_RELOCATION_CNF_OPEN_ERROR  = (sHIERARCHICAL_RELOCATION_INSTNACE_ERROR - 4)
};
