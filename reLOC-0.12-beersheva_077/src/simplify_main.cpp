...
/*                                                                            */
/*============================================================================*/
// simplify_main.cpp / 0.12-beersheva_077
/*----------------------------------------------------------------------------*/
//
...
/*----------------------------------------------------------------------------*/
	...
	while (clause != simplified_formula.end())
	{
	    ...
	    {
		FILE *fw;
		sString eliminate_filename = "simplify/eliminate_" + sInt_32_to_String(getpid()) + ".cnf";
		sString answer_filename = "simplify/answer_" + sInt_32_to_String(getpid()) + ".txt";
