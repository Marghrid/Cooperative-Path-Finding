...
// sMultirobotSolutionCompressor
    ...
    const sString sMultirobotSolutionCompressor::CNF_RELAXED_MDD_FILENAME_PREFIX = "compress/makespan_compression_input.rmdd";
    const sString sMultirobotSolutionCompressor::CNF_MMDD_FILENAME_PREFIX = "compress/makespan_compression_input.mmdd";
    const sString sMultirobotSolutionCompressor::CNF_RELAXED_MMDD_FILENAME_PREFIX = "compress/makespan_compression_input.rmmdd";
    const sString sMultirobotSolutionCompressor::CNF_MDD_plus_FILENAME_PREFIX = "compress/makespan_compression_input.mdd+";
    const sString sMultirobotSolutionCompressor::CNF_MMDD_plus_FILENAME_PREFIX = "compress/makespan_compression_input.mmdd+";
    const sString sMultirobotSolutionCompressor::CNF_MDD_plus_plus_FILENAME_PREFIX = "compress/makespan_compression_input.mdd++";
    const sString sMultirobotSolutionCompressor::CNF_MMDD_plus_plus_FILENAME_PREFIX = "compress/makespan_compression_input.mmdd++";        
    ...
    const sString sMultirobotSolutionCompressor::OUTPUT_RELAXED_MDD_FILENAME_PREFIX = "compress/makespan_compression_output.rmdd";    
    const sString sMultirobotSolutionCompressor::OUTPUT_MMDD_FILENAME_PREFIX = "compress/makespan_compression_output.mmdd";
    const sString sMultirobotSolutionCompressor::OUTPUT_RELAXED_MMDD_FILENAME_PREFIX = "compress/makespan_compression_output.rmmdd";    
    const sString sMultirobotSolutionCompressor::OUTPUT_MDD_plus_FILENAME_PREFIX = "compress/makespan_compression_output.mdd+";
    const sString sMultirobotSolutionCompressor::OUTPUT_MMDD_plus_FILENAME_PREFIX = "compress/makespan_compression_output.mmdd+";
    const sString sMultirobotSolutionCompressor::OUTPUT_MDD_plus_plus_FILENAME_PREFIX = "compress/makespan_compression_output.mdd++";
    const sString sMultirobotSolutionCompressor::OUTPUT_MMDD_plus_plus_FILENAME_PREFIX = "compress/makespan_compression_output.mmdd++";    
   ...
   if (optimal_makespan != MAKESPAN_UNDEFINED)
   {
       switch (m_encoding)
       {
          ...
          case ENCODING_RELAXED_MMDD:
          {
              ...
              result = extract_ComputedRelaxedMmddSolution(start_arrangement, environment, MDD, optimal_makespan, final_encoding_context, optimal_solution, thread_id);
              if (sFAILED(result))
              {
                  return result;
              }
          ...
          case ENCODING_MMDD_plus:
          {
              ...
              result = extract_ComputedMmddPlusSolution(start_arrangement, environment, MDD, optimal_makespan, final_encoding_context, optimal_solution, thread_id);
              if (sFAILED(result))
              {
                  return result;
              }
          ...
          case ENCODING_MMDD_plus_plus:
          {
              ...
              result = extract_ComputedMmddPlusPlusSolution(start_arrangement, environment, MDD, optimal_makespan, final_encoding_context, optimal_solution, thread_id);
              if (sFAILED(result))
              {
                  return result;
              }
...
case ENCODING_IDMDD_plus:
case ENCODING_ADMDD_plus:
{
   if (thread_id != THREAD_ID_UNDEFINED)
   {
...
case ENCODING_IDMDD_plus_plus:
case ENCODING_ADMDD_plus_plus:
{
   if (thread_id != THREAD_ID_UNDEFINED)
   {
  ...
  int                                             thread_id)
{
	...
	result = compute_OptimalCost_avoid(start_arrangement, final_arrangement, environment, sparse_environment, blocked_solution, optimal_cost, final_encoding_context, thread_id);
	if (sFAILED(result))
	{
       return result;
   }
   ...
   {	
       switch (m_encoding)
       {
           ...
           {		
              ...
              int extra_cost;
              sMultirobotInstance::MDD_vector MDD, extra_MDD, reduced_MDD;

              instance.construct_MDD(final_encoding_context.m_max_total_cost, MDD, extra_cost, extra_MDD);
              instance.reduce_MDD(blocked_solution, MDD, reduced_MDD);
 ...
 int                                             thread_id)
{
	...
	result = compute_OptimalMakespan_avoid(start_arrangement, final_arrangement, environment, sparse_environment, blocked_solution, optimal_makespan, final_encoding_context, thread_id);
   ...
   {	
       switch (m_encoding)
       {
           ...
           {		
              sMultirobotInstance instance(environment, sparse_environment, start_arrangement, final_arrangement);
              sMultirobotInstance::MDD_vector MDD, reduced_MDD;

              instance.construct_MakespanMDD(optimal_makespan - 1, MDD);
              instance.reduce_MDD(blocked_solution, MDD, reduced_MDD);
